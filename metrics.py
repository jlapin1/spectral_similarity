...
def modified_dot_product(mz1, intensity1, mz2, intensity2, mz_weight=1):
...
def massbank_score(intensity1, intensity2):
...
def wasserstein(mz1, intensity1, mz2, intensity2):
    return wasserstein_distance(mz1, mz2, intensity1, intensity2)

# Kendall's Tau Rank correlation
def kendall_tau(intensity1, intensity2):
    tau, _ = kendalltau(intensity1, intensity2)
    return tau

# Mutual Information
def mutual_information(intensity1, intensity2, bins=20):
...
def bray_curtis(intensity1, intensity2):
    return braycurtis(intensity1, intensity2)

# Canberra distance
def canberra_distance(intensity1, intensity2):
    return canberra(intensity1, intensity2)

# Weighted with m/z (Mara cluster style)
def mara_weighted_similarity(mz1, intensity1, mz2, intensity2, mz_scale=1):
...
def diagnostic_weighted_similarity(mz, intensity1, intensity2, diagnostic_mz, diagnostic_weight=2):
